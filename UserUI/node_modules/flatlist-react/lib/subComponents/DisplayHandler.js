...
var DisplayHandler = (function (_super) {
    ...
    DisplayHandler.prototype.styleParentGrid = function (parentComponent) {
        ...
        if (displayGrid || display.grid) {
            ...
            var defaultProps = DisplayHandler.defaultProps;
    ...
    DisplayHandler.prototype.styleParentRow = function (parentComponent) {
        ...
        if (displayRow || display.row) {
            ...
            rowGap_1 = display.rowGap || rowGap_1 || DisplayHandler.defaultProps.display.rowGap;
    ...
    DisplayHandler.prototype.render = function () {
        var parentComponent = this.state.parentComponent;
        return (react_1.default.createElement(react_1.Fragment, null, !parentComponent && react_1.default.createElement("span", { ref: this.childSpanRef, style: { display: 'none' } })));
    };
