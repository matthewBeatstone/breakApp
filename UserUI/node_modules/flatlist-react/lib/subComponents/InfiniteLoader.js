...
var InfiniteLoader = (function (_super) {
    ...
    function InfiniteLoader() {
        ...
        _this.checkIfLoadingIsNeeded = function () {
            ...
            if (scrollingContainer && loadIndicatorContainer) {
                var scrollTop = scrollingContainer.scrollTop, offsetTop = scrollingContainer.offsetTop, clientHeight = scrollingContainer.clientHeight;
                _this.lastScrollTop = scrollTop;
                if (!_this.props.hasMore || _this.waitingForUpdate) {
                    return;
                }
                var loaderPosition = (loadIndicatorContainer.offsetTop - scrollTop);
                var startingPoint = offsetTop + clientHeight;
                if (loaderPosition <= startingPoint) {
                    _this.waitingForUpdate = true;
    ...
    InfiniteLoader.prototype.componentDidUpdate = function () {
    ...
    InfiniteLoader.prototype.checkIfListChanged = function () {
        var currentItemsCount = this.getScrollingContainerChildrenCount();
    ...
    InfiniteLoader.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { ref: this.loaderContainerRef, className: '__infinite-loader', style: styles }, hasMore &&
            (loadingIndicator ?
                ...
                DefaultLoadIndicator_1.default)));
    };
